...
var cmdStrings = map[string][2]string{
	...
	"officeaction.assign-patents":            {"Assign to office action", "Assign the selected patent(s) to one or more of the matter's office actions for review — opens an office-action picker. The assignment shows in the catalog OA column and is filterable with oa:."},
	"officeaction.release-patents":           {"Remove from office action", "Remove the selected patent(s) from one or more office actions they are assigned to — opens an office-action picker."},
