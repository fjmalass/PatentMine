...
var cmdStrings = map[string][2]string{
	...
	"patent.expiration-date":         {"Patent expiration analysis", "Compute and display USPTO expiration date compared to Google Patents expiration date for the selected patent."},
...
var englishNamed = map[Key]string{
	...
	StatusFamilyExportDone:        "exported family graph (%d nodes) to %s",
	StatusFamilyExportFailed:      "family graph export failed: %s",
