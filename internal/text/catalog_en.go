...
var cmdStrings = map[string][2]string{
	...
	"view.assignees":                         {"Open assignee timeline", "Open the unified ownership timeline overlay for a single patent, displaying when assignments were made and discovered."},
	"view.assignee-stats":                    {"Open assignee stats", "Open the statistics popup for all assignees, preselecting the current patent's assignee when available."},
	...
	"view.assignees-project":                 {"Project Assignees", "Open the active project's assignee rollup: current owners (live patents only) vs. every assignee ever, with live/expired/not-fetched coverage."},
