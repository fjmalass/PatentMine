...
var cmdStrings = map[string][2]string{
	...
	"view.assignees":                         {"Project Assignees Rollup", "Open the active project's assignee rollup: current owners (live patents only) vs. every assignee ever, with live/expired/not-fetched coverage."},
	"view.assignees-project":                 {"Open assignee stats", "Open the statistics popup for all assignees, preselecting the current patent's assignee when available."},
