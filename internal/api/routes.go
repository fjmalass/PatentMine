...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /assignees", s.handleAllAssigneesHistory)
	s.mux.HandleFunc("GET /assignees/history", s.handleAllAssigneesHistory)
	s.mux.HandleFunc("GET /assignees/stats", s.handleAllAssigneesHistory)
