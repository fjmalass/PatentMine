...
func NewDetail(client *rpc.Client, theme render.Theme, number domain.PatentNumber, project domain.ProjectID, boundLetters []rune) *Detail {
	...
	d.handlers = map[command.ID]cmdHandler{
		...
		command.CrawlFamily: func(Invocation) tea.Cmd {
			return CrawlCmd(d.client, d.project, d.number, crawlFamilyDepth, domain.CrawlProfileFamily, false)
		},
		command.CrawlCitations: func(Invocation) tea.Cmd {
			return CrawlCmd(d.client, d.project, d.number, crawlFamilyDepth, domain.CrawlProfileCitations, false)
		},
		command.CrawlCitedBy: func(Invocation) tea.Cmd {
			return CrawlCmd(d.client, d.project, d.number, crawlFamilyDepth, domain.CrawlProfileCitedBy, false)
		},
		command.CrawlAll: func(Invocation) tea.Cmd {
			return CrawlCmd(d.client, d.project, d.number, crawlFamilyDepth, domain.CrawlProfileAll, false)
		},
		command.LookupPatent: func(Invocation) tea.Cmd {
			...
			return CrawlCmd(d.client, d.project, d.number, lookupDepth, "", true)
		},
	}
	return d
}
