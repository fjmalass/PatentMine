...
func DefaultHints() map[command.Scope][]Hint {
	return map[command.Scope][]Hint{
		command.ScopeCatalog: {
			...
			{Commands: []command.ID{command.OpenChildren}, Label: text.HintChildren},
			...
			{Commands: []command.ID{command.AddToProject, command.MarkActive, command.MarkUnderReview, command.MarkIgnored, command.MarkDeleted, command.IDSCycleStatus}, Label: text.HintProjectActions},
