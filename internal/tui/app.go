...
var appHandlers = map[command.ID]appHandler{
	...
	command.FamilyExportMermaid:        (*App).cmdFamilyExportMermaid,
	...
	command.FetchAssignmentsProject:    (*App).cmdFetchAssignmentsProject,
	...
	command.UntrackRenewals:            (*App).cmdUntrackRenewals,
	command.FetchRenewalValidations:    (*App).cmdFetchRenewalValidations,
	command.ListRenewalValidations:     (*App).cmdListRenewalValidations,
	command.SetRenewalValidation:       (*App).cmdSetRenewalValidation,
...
var typedAcceptsArgs = map[command.ID]bool{
	...
	command.UntrackRenewals:         true,
	command.FetchRenewalValidations: true,
	command.ListRenewalValidations:  true,
	command.SetRenewalValidation:    true,
