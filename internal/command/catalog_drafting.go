...
func draftingCommands() []Command {
	return []Command{
		...
		Command{ID: AssignOfficeAction, Name: "assign.officeaction", Aliases: []string{"assign-officeaction", "assign.oa"}, Usage: ":assign.officeaction [name]", Kind: KindView, Scopes: patentScopes},
		Command{ID: ReleaseOfficeAction, Name: "release.officeaction", Aliases: []string{"release-officeaction", "release.oa"}, Usage: ":release.officeaction [name]", Kind: KindView, Scopes: patentScopes},
		...
		Command{ID: FlagConflict, Name: "flag.conflict", Aliases: []string{"flag-conflict", "conflict"}, Usage: ":flag.conflict <patent-number> [reason]", Kind: KindView, Scopes: projectScopes},
		Command{ID: ListConflicts, Name: "list.conflicts", Aliases: []string{"list-conflicts", "conflicts"}, Usage: ":list.conflicts", Kind: KindView, Scopes: projectScopes},
		...
		Command{ID: ValidateTime, Name: "validate.time", Aliases: []string{"validate-time", "review.worklog", "review-worklog"}, Usage: ":validate.time", Kind: KindView, Scopes: projectScopes},
		Command{ID: ShowTime, Name: "show.time", Aliases: []string{"show-time", "worklog"}, Usage: ":show.time", Kind: KindView, Scopes: projectScopes},
