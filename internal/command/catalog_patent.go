...
func patentCommands() []Command {
	return []Command{
		...
		Command{ID: FetchAssignmentsProject, Name: "fetch.uspto.assignments.project", Aliases: []string{"fetch-assignments-project"}, Usage: ":fetch.uspto.assignments.project [include-expired]", Kind: KindEngine, Method: proto.MethodUSPTOFetchAssignmentsBatch, Scopes: projectScopes},
