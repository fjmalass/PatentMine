...
func viewCommands() []Command {
	return []Command{
		...
		Command{ID: OpenBrowser, Name: "browse", Aliases: []string{"web"}, Usage: ":browse [PATENT ...]", Kind: KindView, Scopes: patentScopes},
		Command{ID: OpenBrowserUSPTO, Name: "browse.uspto", Usage: ":browse.uspto [PATENT ...]", Kind: KindView, Scopes: patentScopes},
		Command{ID: OpenBrowserUSPTOGrant, Name: "browse.uspto.grant", Usage: ":browse.uspto.grant [PATENT ...]", Kind: KindView, Scopes: patentScopes},
		Command{ID: OpenBrowserUSPTOPGPub, Name: "browse.uspto.pgpub", Usage: ":browse.uspto.pgpub [PATENT ...]", Kind: KindView, Scopes: patentScopes},
		Command{ID: OpenBrowserGoogle, Name: "browse.google", Usage: ":browse.google [PATENT ...]", Kind: KindView, Scopes: patentScopes},
		Command{ID: OpenMetrics, Name: "metrics", Aliases: []string{"observability"}, Usage: ":metrics", Kind: KindView},
		...
		Command{ID: FamilyDepthMore, Name: "family.depth.more", Kind: KindView, Scopes: []Scope{ScopeFamily}, Usage: ":family.depth.more"},
		Command{ID: FamilyDepthLess, Name: "family.depth.less", Kind: KindView, Scopes: []Scope{ScopeFamily}, Usage: ":family.depth.less"},
		Command{ID: FamilyExportMermaid, Name: "export.family.mermaid", Aliases: []string{"family.mermaid"}, Usage: ":export.family.mermaid [PATH]", Kind: KindView, Scopes: patentScopes},
		...
		Command{ID: OpenOrphans, Name: "orphans", Aliases: []string{"unassigned"}, Usage: ":orphans", Kind: KindView},
		Command{ID: NotesSortToggle, Kind: KindView, Scopes: []Scope{ScopeNotes}},
		Command{ID: NotesExportMD, Name: "export.notes", Aliases: []string{"notes.export"}, Usage: ":export.notes", Kind: KindView, Scopes: []Scope{ScopeNotes}},
		Command{ID: Refresh, Name: "refresh", Kind: KindView, Scopes: []Scope{ScopeCatalog, ScopeDetail, ScopeCitations, ScopeFamily, ScopeProjects, ScopeIDS}, Usage: ":refresh"},
		Command{ID: OpenSearch, Kind: KindView, Scopes: []Scope{ScopeCatalog, ScopeDetail, ScopeCitations, ScopeFamily, ScopeProjects}},
		Command{ID: FullTextSearch, Name: "search.fulltext", Aliases: []string{"fulltext.search", "grep"}, Usage: ":search.fulltext [query]", Kind: KindView, Scopes: []Scope{ScopeCatalog}},
		Command{ID: OpenCommand, Kind: KindView},
		Command{ID: JumpMode, Name: "jump", Kind: KindView, Scopes: []Scope{ScopeDetail}, Usage: ":jump"},
		...
		Command{ID: ProjectActivate, Name: "project.use", Usage: ":project.use [PROJECT]", Kind: KindView, Scopes: projectScopes},
		Command{ID: ProjectClearActive, Name: "project.clear", Usage: ":project.clear", Kind: KindView, Scopes: projectScopes},
		...
		Command{ID: FindNext, Name: "find.next", Kind: KindView, Scopes: []Scope{ScopeFullText}, Usage: ":find.next"},
		Command{ID: FindPrev, Name: "find.prev", Aliases: []string{"find.previous"}, Usage: ":find.prev", Kind: KindView, Scopes: []Scope{ScopeFullText}},
		Command{ID: IDSEditField, Kind: KindView, Scopes: []Scope{ScopeIDS}},
		Command{ID: IDSToggleFull, Kind: KindView, Scopes: []Scope{ScopeIDS}},
		Command{ID: IDSCycleStatus, Name: "ids.cycle-status", Aliases: []string{"ids.cycle"}, Usage: ":ids.cycle-status", Kind: KindView, Scopes: []Scope{ScopeCatalog, ScopeDetail, ScopeCitations, ScopeFamily, ScopeIDS}},
		...
		Command{ID: AIAnalyze, Name: "ai.analyze", Aliases: []string{"ai"}, Usage: ":ai.analyze", Kind: KindView, Scopes: []Scope{ScopeDetail}},
		...
		Command{ID: CopyYankMeta, Name: "copy.meta", Usage: ":copy.meta", Kind: KindView, Scopes: []Scope{ScopeFullText}},
		Command{ID: CopyAll, Name: "copy.all", Aliases: []string{"yank.all"}, Usage: ":copy.all", Kind: KindView, Scopes: []Scope{ScopeFullText}},
		Command{ID: FullTextStageNext, Name: "fulltext.stage.next", Aliases: []string{"stage.next"}, Usage: ":fulltext.stage.next", Kind: KindView, Scopes: []Scope{ScopeFullText}},
		Command{ID: FullTextStagePrev, Name: "fulltext.stage.prev", Aliases: []string{"stage.prev", "fulltext.stage.previous"}, Usage: ":fulltext.stage.prev", Kind: KindView, Scopes: []Scope{ScopeFullText}},
		Command{ID: FullTextCollapse, Name: "fulltext.collapse", Kind: KindView, Scopes: []Scope{ScopeFullText}, Usage: ":fulltext.collapse"},
		Command{ID: FullTextQuickList, Name: "fulltext.quicklist", Aliases: []string{"quicklist"}, Usage: ":fulltext.quicklist", Kind: KindView, Scopes: []Scope{ScopeFullText}},
		Command{ID: NoteAdd, Name: "note.add", Aliases: []string{"note"}, Usage: ":note.add", Kind: KindView, Scopes: []Scope{ScopeFullText}},
		Command{ID: NoteOpen, Name: "note.open", Kind: KindView, Scopes: []Scope{ScopeFullText}, Usage: ":note.open"},
	}
}
