...
func viewCommands() []Command {
	return []Command{
		...
		Command{ID: OpenAssignees, Name: "open.assignees", Aliases: []string{"assignees"}, Usage: ":open.assignees", Kind: KindView, Scopes: projectScopes},
		Command{ID: OpenAssigneesProject, Name: "open.assignees.project", Aliases: []string{"assignees.project", "project-assignees", "assignee-stats", "assignee-analytics"}, Usage: ":open.assignees.project", Kind: KindView, Scopes: patentScopes},
