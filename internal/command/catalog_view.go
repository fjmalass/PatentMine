...
func viewCommands() []Command {
	return []Command{
		...
		Command{ID: OpenAssignees, Name: "open.assignees", Aliases: []string{"assignees"}, Usage: ":open.assignees", Kind: KindView, Scopes: patentScopes},
		Command{ID: OpenAssigneesProject, Name: "open.assignees.project", Aliases: []string{"assignees.project", "project-assignees"}, Usage: ":open.assignees.project", Kind: KindView, Scopes: projectScopes},
		Command{ID: OpenAssigneeStats, Name: "open.assignee-stats", Aliases: []string{"assignee-stats", "assignee-analytics"}, Usage: ":open.assignee-stats", Kind: KindView, Scopes: patentScopes},
