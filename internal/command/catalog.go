...
const (
	...
	FetchRenewalValidations ID = "renewal.validation.fetch"     // pull EP/national validation state from EPO OPS
	ListRenewalValidations  ID = "renewal.validation.list"      // show stored country-phase validation state
	SetRenewalValidation    ID = "renewal.validation.set"       // manually set one country-phase validation state
...
// Generic local view commands may keep view/open wording when it reads better
// (open.projects, browse.uspto).
